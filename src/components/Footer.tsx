          ...
          {/* Social / Hours */}
           <div>
            ...
            <div className="mt-6">
                ...
                <p className="text-sm text-slate-400">{t.footer.mon_fri}: 10:00 AM - 6:00 PM</p>
                <p className="text-sm text-slate-400">{t.footer.sat}: 10:00 AM - 3:00 PM</p>
                <p className="text-sm text-slate-400">{t.footer.sun}: Closed</p>
            </div>
          </div>
        </div>
